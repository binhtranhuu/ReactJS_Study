...
class ContentRelated extends Component {
    constructor(props){
        super(props);
    }
    ...
    render() {
        return (
            <div className="card">
                <Link to={"/tin-tuc/" + this.chuyenDoiUrl(this.props.tieuDe) + "." + this.props.contentId + ".html"}><img src="http://placehold.it/800x400" className="card-img-top" alt="..." /></Link>
