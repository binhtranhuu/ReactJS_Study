...
class AddUser extends Component {
    ...
    showFormAddUser = () => {
        if (this.props.showFormAddUser === true) {
            return (
                <div className="col">
                    ...
                    <form>
                        ...
                        <button onClick={(name, phone, permission) => this.props.getNewUserData(this.state.name, this.state.phone, this.state.permission)} type="reset" className="btn btn-success btn-block">Thêm mới</button>
                    </form>
                </div>
            )
        }
